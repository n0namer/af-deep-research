...
- validation after hard-signal instrumentation: `py_compile` PASS; `22` direct evaluation/ResearchRun regressions PASS; existing `test_full_coverage_evidence_only_report_is_delivery_verified` PASS. Canonical pytest remains unavailable in the runtime image;
- CURRENT hashes: `evaluation.py` `54bf174195feefff9fb28d2a8f665b196d8b601e1f62ad827b8c80d3fc8aa063`; `research_run.py` `6a7728846b006254abe7d7aea8691c1fcbbb04faf963c496e9f137bd8686d942`; `verified_pipeline.py` `99306d87e144acb10032927e247f0e0015443c865a4a1888cf2cf7d1a07e3b35`; `tests/test_evaluation_suite.py` `e263da60fa49c1880d52019740c04b8226763653a198eb8c7dbaa0a360b03ddf`; `tests/test_research_run.py` `514e618b676f3d8e7564d64a65a0ad4120cf999dcc57f417ce8a6df631877e61`;
