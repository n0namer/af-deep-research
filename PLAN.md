...
- frozen regression core expanded from 6 pilots to **24 deterministic cases** across at least 8 domains and 9 capability/failure classes. All 24 baseline corpora replay to expected PASS; removing all decisive admissible evidence from each case makes all 24 FAIL closed. The original six remain stable pilot/anchor cases inside the larger core;
- validation after 24-case expansion: `py_compile` PASS; `25` direct evaluation/ResearchRun regressions PASS; existing `test_full_coverage_evidence_only_report_is_delivery_verified` PASS. Canonical pytest remains unavailable in the runtime image;
- CURRENT hashes: `evaluation.py` `93e935381045c8942cbab6f8b491cf24992e1c709c5a0c8c9dd663608e07a391`; `research_run.py` `6a7728846b006254abe7d7aea8691c1fcbbb04faf963c496e9f137bd8686d942`; `verified_pipeline.py` `99306d87e144acb10032927e247f0e0015443c865a4a1888cf2cf7d1a07e3b35`; `tests/test_evaluation_suite.py` `4125bd6f4f5921d3a74f12b3c82e7141ee5a0866533bea4b5206b489c15af42d`; `tests/test_research_run.py` `514e618b676f3d8e7564d64a65a0ad4120cf999dcc57f417ce8a6df631877e61`;
