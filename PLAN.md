...
- `evaluation.py` now provides `evaluate_stored_semantic_snapshot()` and `evaluate_research_run_snapshot()`: a complete stored snapshot can PASS/FAIL entirely offline, but any required missing hard signal yields `EVIDENCE_MISSING`; a wrong requirement state yields FAIL even if other signals are missing;
...
- CURRENT hashes: `evaluation.py` `9ce0dd107c1d1bb24f690f7ac42ec271b54e9f5591cb221eff6a3fbcb6f30590`; `research_run.py` `6a7728846b006254abe7d7aea8691c1fcbbb04faf963c496e9f137bd8686d942`; `verified_pipeline.py` `c66ddc57046dea44543b6c02bfa76e81cacaa6bbfeb2409c796b783c767be9d4`; `tests/test_evaluation_suite.py` `c7e754abb8629dd2515346de08f8ae9661c1e90b767ff8938c409254eb14331c`; `tests/test_research_run.py` `514e618b676f3d8e7564d64a65a0ad4120cf999dcc57f417ce8a6df631877e61`;
